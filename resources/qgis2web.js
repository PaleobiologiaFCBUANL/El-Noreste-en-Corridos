...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-11927035.548787, 2511018.117131, -10319650.333767, 3522215.213493], maxZoom: 28, minZoom: 6
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11927035.548787, 2511018.117131, -10319650.333767, 3522215.213493], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">El Noreste en Corridos</h2>';
        return titleElement;
    })(),
